...
class Page extends EventEmitter {
  ...
  constructor(client, target, frameTree, ignoreHTTPSErrors, screenshotTaskQueue) {
    ...
    this._networkManager.on(Events.NetworkManager.BeforeResponse, event => this.emit(Events.Page.BeforeResponse, event));
  ...
  async setResponseInterception(value) {
    return this._networkManager.setResponseInterception(value);
  }
